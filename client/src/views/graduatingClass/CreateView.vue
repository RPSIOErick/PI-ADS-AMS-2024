...
async function getAlunos() {
    ...
    console.log(
      "\nNome Turma "+ nomeTurma.value,
      "\nTurno Turma "+ turnoTurma.value,
      "\nResponsavel Turma "+ responsavel.value,
      "\nSemestre Turma "+ semestreTurma.value,
      "\nAno Turma "+ anoTurma.value,
      "\nAlunos Turma "+ alunos.value.map(aluno => aluno.Cod_Aluno),
      "\nId Disciplina "+ ID_Disc.value,
      "\nCod Curso "+ Cod_Curso.value
    )

    try {
      console.log(formData.Cod_Curso)
...
<template>
  ...
  <form @submit.prevent="submitTurma">
    ...
    <label for="disciplina">Codigo do Curso:</label>
    <input type="text" v-model="Cod_Curso" />
